...
public class GraphPlace extends GraphElement {
    ...
    public static void setDiameter(int aDiameter) { diameter = aDiameter; }

    private Ellipse2D graphElement = new Ellipse2D.Double(0, 0, getDiameter(), getDiameter());
