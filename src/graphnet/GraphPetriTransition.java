...
public class GraphPetriTransition extends GraphTransition implements Serializable {
    ...
    public void drawGraphElement(Graphics2D g2) {
    	if(transition.getPriority() < 10 && transition.getPriority()>=0)setWidth(GraphTransition.getDefaultwidth()+transition.getPriority());
        else if(transition.getPriority() >= 10) setWidth(15);
