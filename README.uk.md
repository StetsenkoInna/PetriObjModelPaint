...
<sergey24rybak@gmail.com> або <inna.stetsenko-fiot@edu.kpi.ua>.

## Автори

- **Проф. Інна Стеценко** — КПІ ім. Ігоря Сікорського; авторка технології
  Петрі-об'єктного моделювання та оригінального PetriObjModelPaint.
- **Сергій Рибак (sergiorbk)** — КПІ ім. Ігоря Сікорського; багатомодульна архітектура,
  розвиток десктопного редактора, PNML та сервер симуляції.
