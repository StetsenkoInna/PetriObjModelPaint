...
Графічний редактор та симулятор мереж Петрі (v2.2.0), також відомий як
**PetriObjModelPaint**. Багатомодульний Maven-проєкт:
...
мовою — AI-агент складе з неї мережу з каталогу готових патернів; далі її можна
