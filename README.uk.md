...
робите імпорт/експорт PNML. На шарі структури кілька мереж компонуються в Петрі-об'єктну
модель, і всі її об'єкти анімуються одночасно, кожен у своєму вікні.

**[docs/desktop-ui.md](docs/desktop-ui.md)** (англійською) — повний посібник: редактор,
керування анімацією, модуль статистики, структура Петрі-об'єктної моделі, бібліотека мереж,
імпорт/експорт PNML.
